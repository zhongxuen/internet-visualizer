/**
 * DNS Explorer's registry identity.
 *
 ...
 * module has to spell `'dns-explorer'` again and a rename is one edit.
 */

import { getModule, type ModuleMeta } from '@/modules/registry';

/** This module's registry id. */
export const DNS_EXPLORER_ID = 'dns-explorer';
 ...
 */
export function dnsExplorerMeta(): ModuleMeta | undefined {
  return getModule(DNS_EXPLORER_ID);
}
