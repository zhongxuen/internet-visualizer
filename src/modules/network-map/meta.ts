/**
 * The Network Map's registry identity.
 *
 ...
 * module has to spell `'network-map'` again and a rename is one edit.
 */

import { getModule, type ModuleMeta } from '@/modules/registry';

/** This module's registry id. */
export const NETWORK_MAP_ID = 'network-map';
 ...
 */
export function networkMapMeta(): ModuleMeta | undefined {
  return getModule(NETWORK_MAP_ID);
}
