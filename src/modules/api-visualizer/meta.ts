/**
 * API Visualizer's registry identity.
 *
 ...
 * spell `'api-visualizer'` again and a rename is one edit.
 */

import { getModule, type ModuleMeta } from '@/modules/registry';

/** This module's registry id. */
export const API_VISUALIZER_ID = 'api-visualizer';
 ...
 */
export function apiVisualizerMeta(): ModuleMeta | undefined {
  return getModule(API_VISUALIZER_ID);
}
