/**
 * WebSocket Viewer's registry identity.
 *
 ...
 * spell `'websocket-viewer'` again and a rename is one edit.
 */

import { getModule, type ModuleMeta } from '@/modules/registry';

/** This module's registry id. */
export const WEBSOCKET_VIEWER_ID = 'websocket-viewer';
 ...
 */
export function webSocketViewerMeta(): ModuleMeta | undefined {
  return getModule(WEBSOCKET_VIEWER_ID);
}
