              ...
              return (
                ...
                >
                  <td className="py-2 pr-3 whitespace-nowrap">
                    <code className="text-fg text-caption font-mono tabular-nums">
                      {info.code}
                    </code>
                    <p className="text-fg-secondary text-caption mt-0.5">{info.name}</p>
                    {info.sender ? (
                  ...
                  <td className="text-fg-muted text-caption py-2 leading-relaxed">
                    {info.meaning}
                  </td>
                </tr>
              );
        ...
        <dl className="flex flex-col gap-1.5">
          {RANGES.map((range) => (
            ...
            >
              ...
              <dd className="text-fg-muted text-caption leading-relaxed">
